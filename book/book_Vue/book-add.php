    ...
    <header> <h1> Livre </h1>  </header>
        <form  method = "POST" action ="">
            ...
            <div id="cod">
                ...
                <input type="text" id="code " readonly value="<?php $c = rand(1,1000); $code = "".$c; echo $code ; ?>"  required placeholder="readonly " name="code" />
            </div>
            <div id="name">
            ...
            <div id="boton">
                <button id="btn" name = "ajouter" >Ajouter</button>
            </div>
        </form>
