    ...
    <header> <h1> Etudiant </h1>  </header>
        <form  method = "POST" action ="">
            ...
            <div id="cod">
                ...
                <input type="text" id="code " readonly value="<?php $c = rand(1,1000); $code = "i".$c; echo $code ; ?>"  required placeholder="readonly " name="code" />
            </div>
            <div id="name">
            ...
            <div id="boton">
                <button id="btn" name = "creer" >Créer</button>
            </div>
        </form>
